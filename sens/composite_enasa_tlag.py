...
ms = {'asa':8,'mem8*1':5,'mem8*2':5,'mem8*3':5,'mem8*4':5,'mem8*5':5}
...
figdJ.savefig(figdir/f"composite_dJdx0{metric}_vt{vt}{solver}nens{nensbase}lag.png",dpi=300)
figdx.savefig(figdir/f"composite_dx0opt{metric}_vt{vt}{solver}nens{nensbase}lag.png",dpi=300)
#plt.show()