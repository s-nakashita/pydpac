...
```{python}
model = "l05nestm"
datadir = Path(f'work/{model}/envar_nestc_shrink_preGM_m80obs30')
...
#| output: false
    ...
    crosscov=True,ridge=True,mu=0.0,model="l05nestm")
...
#| output: false
    ...
    for mu in mulist:
        #mu = 0.01
        envar_nestc = EnVAR_nest(state_size,nmem,obs,ix_gm,ix_lam,pt="envar_nestc",ntrunc=12,\
        crosscov=True,ridge=False,reg=True,mu=mu,model="l05nestm")
...
#| output: false
        ...
        for ga in galist:
            envar_nestc = EnVAR_nest(state_size,nmem,obs,ix_gm,ix_lam,pt="envar_nestc",ntrunc=12,\
            crosscov=True,reg=False,ridge=True,mu=ga,model="l05nestm")
            solverlist.append(envar_nestc)
...
#| output: false
        ...
        for ga in galist:
            envar_nestc = EnVAR_nest(state_size,nmem,obs,ix_gm,ix_lam,pt="envar_nestc",ntrunc=12,\
            crosscov=True,reg=False,ridge=False,ridge_dx=True,mu=ga,model="l05nestm")
            solverlist.append(envar_nestc)
...
datadir = Path(f'work/{model}/envar_nestc_shrink_preGM_m80obs30')
ea_nc  = np.loadtxt(datadir/'e_lam_linear_envar_nest.txt')
ef_nc  = np.loadtxt(datadir/'ef_lam_linear_envar_nest.txt')
ea_psd = np.loadtxt(datadir/'e_lam_linear_envar_nestc.txt')
ef_psd = np.loadtxt(datadir/'ef_lam_linear_envar_nestc.txt')
datadir = Path(f'work/{model}/envar_nestc_reg_shrink_preGM_m80obs30')
ea_reg = np.loadtxt(datadir/'e_lam_linear_envar_nestc.txt')
ef_reg = np.loadtxt(datadir/'ef_lam_linear_envar_nestc.txt')
datadir = Path(f'work/{model}/envar_nestc_ridge_shrink_preGM_m80obs30')
ea_ridge = np.loadtxt(datadir/'e_lam_linear_envar_nestc.txt')
ef_ridge = np.loadtxt(datadir/'ef_lam_linear_envar_nestc.txt')
...
datadir = Path(f'work/{model}/envar_nestc_shrink_preGM_m80obs30')
xda_nc  = np.loadtxt(datadir/'xdmean_lam_linear_envar_nest.txt')
xdf_nc  = np.loadtxt(datadir/'xdfmean_lam_linear_envar_nest.txt')
xda_psd = np.loadtxt(datadir/'xdmean_lam_linear_envar_nestc.txt')
xdf_psd = np.loadtxt(datadir/'xdfmean_lam_linear_envar_nestc.txt')
datadir = Path(f'work/{model}/envar_nestc_reg_shrink_preGM_m80obs30')
xda_reg = np.loadtxt(datadir/'xdmean_lam_linear_envar_nestc.txt')
xdf_reg = np.loadtxt(datadir/'xdfmean_lam_linear_envar_nestc.txt')
datadir = Path(f'work/{model}/envar_nestc_ridge_shrink_preGM_m80obs30')
xda_ridge = np.loadtxt(datadir/'xdmean_lam_linear_envar_nestc.txt')
xdf_ridge = np.loadtxt(datadir/'xdfmean_lam_linear_envar_nestc.txt')
...
datadir = Path(f'work/{model}/envar_nestc_shrink_preGM_m80obs30')
j_nc  = np.loadtxt(datadir/f'{model}_lam_jh_linear_envar_nest.txt')
j_psd = np.loadtxt(datadir/f'{model}_lam_jh_linear_envar_nestc.txt')
datadir = Path(f'work/{model}/envar_nestc_reg_shrink_preGM_m80obs30')
j_reg = np.loadtxt(datadir/f'{model}_lam_jh_linear_envar_nestc.txt')
datadir = Path(f'work/{model}/envar_nestc_ridge_shrink_preGM_m80obs30')
j_ridge = np.loadtxt(datadir/f'{model}_lam_jh_linear_envar_nestc.txt')
